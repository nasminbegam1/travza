  ...
  var long_arr	=	$.parseJSON(<?php print json_encode(json_encode( $friend_long_arr)); ?>);
    ...
    <script type="text/javascript">
       ...
       */
       ...
       var longitude=0;
       var zoomer=1;
       function show_bucket_map(id,typ,own){
       //alert(typ);
	      $.ajax({			
			    type: "POST",
...
<!--        <div class="frnd_list">
      ...
      <div class="dashboard">
        <div id="scrollbar1">
		  ...
		  $cmp_count = 0;
		    ...
		    id="main_<?php echo $bucket['bucket_id'];?>">
				   ...
				   <a href="javascript:void(0);" onclick='show_bucket_map("<?php echo $bucket['deal_flyer_id'];?>","<?php echo $bucket['type'];?>");' data-toggle="modal" class="view-flyer" data-element="<?php echo $bucket['deal_flyer_id'];?>" data-target="#view-flyer<?php echo $bucket['deal_flyer_id'];?>">
					  <p><?php echo $bucket['title'];?></p>
				   </a>
				   <?php }else{ ?>
				   <a href="javascript:void(0);" onclick='show_bucket_map("<?php echo $bucket['deal_flyer_id'];?>","<?php echo $bucket['type'];?>");' data-toggle="modal" class="view-offer" data-element="<?php echo $bucket['deal_flyer_id'];?>" data-target="#view-offer<?php echo $bucket['deal_flyer_id'];?>">
					  <p><?php echo $bucket['title'];?></p>
				   </a>
				<?php }?>
		...
		<li id="own_<?php echo $ownbucket['bucket_id'];?>">
		  ...
		  <span><a href="javascript:void(0);" data-toggle="modal" class="own-flyer" data-element="<?php echo $ownbucket['deal_flyer_id'];?>" data-target="#own-flyer"><p><?php echo $ownbucket['flyer_title']; ?></p></a></span>
