...
<?php //pr($friend_bucket_id);//pr($friend_list); //pr($friend_lat_arr,0); pr($friend_long_arr); // bd631e5d6146582695ef6643e004a55a ?>
 ...
 <div class="modal fade" id="view-review" tabindex="-1" role="dialog" aria-hidden="true">
	   <div class="modal-dialog">
	       <div class="modal-content">
		       <div class="modal-header">
			  Review Details     <button class="close" aria-hidden="true" data-dismiss="modal" type="button">&times;</button>
		       </div>
		       <div class="modal-body">
			   <div id="view_review_details" class="offer_details_Box">Loading...</div> 
		       </div>
	       </div><!-- /.modal-content -->
	   </div><!-- /.modal-dialog -->
</div><!-- /.modal ---->
