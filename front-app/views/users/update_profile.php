      ...
      ?>
        ...
        <div class="joinForm">
			...
			<div class="field">
                            ...
                            <div class="input-box">
				 <div class="chk">
				    <input type="checkbox" name="remainderEmail" id="traveler_type" value="Y" <?php if($user_profile[0]['remainderEmail']=='Y'){echo 'checked="checked"';}?>/>
				    Want to Receive Remainder Email for Bucket List?
				 </div>
                            </div>
                        </div>
		    </li>
