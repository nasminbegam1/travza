		...
		if(isset($deal_list) && is_array($deal_list) && count($deal_list) > 0)
		{
			...
			foreach($deal_list as $deal)
			{
				...
				$deal_image = FILE_UPLOAD_URL."offer/thumb/".$deal['deal_image']; ?>
							...
							<!--<a href="javascript:void(0);" data-toggle="modal" class="view-name" data-element="<?php //echo $deal['deal_id'];?>" data-target="#view-name<?php //echo $deal['deal_id'];?>"style="margin-left: 20px;">Name</a>-->
							...
							<ul>
								...
								<li><strong class="bucket"></strong><span><span><?php echo $deal['deal_count'];?></span>&nbsp; bucket list(s)</span></li>
		...
		?>
		  ...
		  if(isset($top_offers) && is_array($top_offers) && count($top_offers) > 0)
		  {
			   ...
			   <div class="dealsBoxTop view-offer" data-toggle="modal" data-element="<?php echo $topoffers['deal_id'];?>" data-target="#view-offer<?php echo $topoffers['deal_id'];?>">
				 ...
				 <!--<a href="javascript:void(0);" data-toggle="modal" class="view-name" data-element="<?php echo $topoffers['deal_id'];?>" data-target="#view-name<?php echo $topoffers['deal_id'];?>"style="margin-left: 20px;">Name</a>-->
				 <a href="javascript:void(0);" data-toggle="modal" class="view-vendor-profile vendorIcon" data-element="<?php echo $deal['created_by'];?>" data-target="#view-vendor-profile<?php echo $deal['created_by'];?>"><img src="<?php echo FRONTEND_URL;?>images/man-blue.png"></a>
				 <ul>
					 <li><strong class="location"></strong><span><?php echo stripcslashes($topoffers['city']);?></span></li>
					 <li><strong class="bucket"></strong><span><span><?php echo $topoffers['CNT'];?></span> bucket list(s)</span></li>
		...
		if(isset($flyer_list) && is_array($flyer_list) && count($flyer_list) > 0)
		{
			foreach($flyer_list as $flyer)
			{
				...
				$flyer_image = FILE_UPLOAD_URL."flyer/thumb/".$flyer['profile_image']; ?>
							...
							<!--<a href="javascript:void(0);" data-toggle="modal" class="view-name" data-element="<?php //echo $flyer['fl_id'];?>" data-target="#view-name<?php //echo $flyer['fl_id'];?>"style="margin-left: 20px;">Name</a>-->
							...
							<ul>
								...
								<li><strong class="bucket"></strong><span><span><?php echo $flyer['flyer_count'];?></span>&nbsp; bucket list(s)</span></li>
	...
	<div class="mainPanThree">
		<div class="mainInnThree">
			<div class="tipsPan">
				...
				<h4><?php echo $total_review;?> and counting successful bucket list goals achieved </h4>
					...
					<div class="tipsBox">
						<div class="tipsBoxTop">
							...
							<div class="tipsBoxTopText">
								...
								<p><?php echo substr(stripslashes($user['experince_tips']),0,20);?></p>
