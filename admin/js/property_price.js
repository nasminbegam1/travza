...
function addMoreSeasons(year){
	...
	appendHTML +='<input type="text" id="dailyprice_'+countSeasons+'" data-type="number" data-required="true" class="form-control requiredInput daily-price-fld" name="season_daily['+year+'][]" value="">';
	...
	appendHTML +='<label for="reg_input_name" class="req">Commission Rate</label><br/>';
	appendHTML +='</div>';
	appendHTML +='<div class="col-sm-12">';
	appendHTML +='<div class="input-group"><span class="input-group-addon"><i class="fa fa-money"></i></span>';
	appendHTML +='<input value="" name="commission_rate['+year+'][]" type="text" class="form-control requiredInput " data-required="true" data-type="number" id="commission_rate_'+countSeasons+'">';
	...
	appendHTML +='<input type="text" id="minrental_'+countSeasons+'" data-type="number" data-required="true" class="form-control requiredInput" name="minimum_rental_days['+year+'][]" value="">';
	...
	appendHTML +='</div><div class="col-sm-12">';
	appendHTML +='<div class="input-group"><span class="input-group-addon"><i class="fa fa-calendar"></i></span>';
	appendHTML +='<input type="text" id="start_date_'+year+"_"+countSeasons+'" data-element="'+countSeasons+'" data-year="'+year+'" name="season_start_date['+year+'][]" class="season_start_date form-control requiredInput rental_start_date date_start_'+countSeasons+'" data-required="true"  value="">';
	appendHTML +='<i class="alert alert-hide">Oops, start date is required</i>';
	appendHTML +='</div></div></div>';
	appendHTML +='<div class="col-sm-4"><div class="col-sm-12">';
	...
	appendHTML +='<div class="col-sm-12">';
	appendHTML +='<div class="input-group"><span class="input-group-addon"><i class="fa fa-calendar"></i></span>';
	appendHTML +='<input type="text" id="end_date_'+year+'_'+countSeasons+'" data-element="'+countSeasons+'" data-year="'+year+'"  name="season_end_date['+year+'][]" class="season_start_date form-control requiredInput rental_end_date date_end_'+countSeasons+'" data-required="true" value="" readonly="">';
	appendHTML +='<i class="alert alert-hide">Oops, end date is required</i>';
	appendHTML +='</div></div></div>';
		...
		var year=$(this).parents(".tableSeasons").attr("id").replace("tableSeasons_",'');
		 ...
		 $(this).parents('.tableSeasons').find(".sub-season").each(function(){
			if (count > 0) {
				...
				$(this).find('input[id^="commission_rate_"]').attr("id","commission_rate_"+s_no);
...
$(document).ready(function(){
	...
	$('.cloneSeason').click(function(){
		...
		if (last_dt == dt1) {
			...
			$.ajax({
				type: "POST",
				url:   base_url+ "property/get_season/",
