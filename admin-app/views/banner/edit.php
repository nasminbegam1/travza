                                                    ...
                                                    <div class="form-body">
                                                        ...
                                                        <div class="form-group"><label for="banner_image" class="col-md-3 control-label">Banner Image<span class='require'>*</span></label>
                                                            ...
                                                            <div class="col-md-4">
                                                               ...
                                                               <br />
                                                            <?php if($arr_banner['banner_image']!='' && file_exists(FILE_UPLOAD_ABSOLUTE_PATH.'banner/'.$arr_banner['banner_image'])){ ?>
                                                                <img src="<?php echo IMAGE_UPLOAD_URL;?>banner/<?php echo $arr_banner['banner_image'];?>" border="0" width="100" height="100">
                                                             <?php } ?>
                                                            </div>
                                                        </div>
