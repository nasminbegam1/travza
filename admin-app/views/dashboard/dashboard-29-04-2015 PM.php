            ...
            <div class="panel panel-blue portlet box portlet-blue">
			  ...
			  <br class="spacer">
			    ...
			    <div id="sum_box" class="row mbl">
					...
					<div class="panel-body"><p class="icon"><i class="icon fa fa-group"></i></p><h4 class="value"><span><?php echo $users_count;?></span></h4>
				    ...
				    <div class="col-sm-6 col-md-4">
				    <div class="panel visit db mbm">
					<div class="panel-body"><p class="icon"><i class="icon fa fa-group" style="color: #6AF7A9;"></i></p><h4 class="value"><span><?php echo $vendors_count;?></span></h4>
				    ...
				    <div class="col-sm-6 col-md-4">
				    <div class="panel visit db mbm">
					<div class="panel-body"><p class="icon"><i class="icon fa fa-facebook" ></i></p><h4 class="value"><span><?php echo $active_flyer;?></span></h4>
				    ...
				    <div class="col-sm-6 col-md-4">
				    <div class="panel visit db mbm">
					<div class="panel-body"><p class="icon"><i class="icon fa fa-facebook" ></i></p><h4 class="value"><span><?php echo $inactive_flyer;?></span></h4>
				    ...
				    <div class="col-sm-6 col-md-4">
				    <div class="panel visit db mbm">
					<div class="panel-body"><p class="icon"><i class="icon fa fa-strikethrough" style="color: #6AF7A9;"></i></p><h4 class="value"><span><?php echo $active_offer;?></span></h4>
				    ...
				    <div class="col-sm-6 col-md-4">
				    <div class="panel visit db mbm">
					<div class="panel-body"><p class="icon"><i class="icon fa fa-strikethrough" style="color: #d9534f;"></i></p><h4 class="value"><span><?php echo $inactive_offer;?></span></h4>
					...
					<div class="panel-body"><p class="icon"><i class="icon fa fa-shopping-cart"></i></p><h4 class="value"><span><?php echo $bucket_count;?></span></h4>
				    ...
				    <div class="col-sm-6 col-md-4">
				    <div class="panel task db mbm">
					<div class="panel-body"><p class="icon"><i class="icon fa fa-stack-exchange"></i></p><h4 class="value"><span><?php echo $review_count;?></span></h4>
