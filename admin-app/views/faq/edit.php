						...
						<input type="hidden" name="action" value="Process">
                                                    <div class="form-body">
                                                        ...
                                                        <div class="form-group"><label for="faq_question" class="col-md-3 control-label">FAQ Question <span class='require'>*</span></label>
                                                            ...
                                                            <div class="col-md-9">
                                                                <input name="faq_question" type="text" placeholder="" class="form-control required" id="faq_question" value="<?php echo stripslashes($faq_master['faq_question']);  ?>"/>
                                                        ...
                                                        <div class="form-group"><label for="faq_answer" class="col-md-3 control-label">FAQ Answer <span class='require'>*</span></label>
                                                            ...
                                                            <div class="col-md-9">
                                                                    ...
                                                                    <textarea  name="faq_answer"   class="ckeditor form-control required"><?php echo stripslashes($faq_master['faq_answer']); ?></textarea>
							...
							<div class="form-group"><label for="faq_type" class="col-md-3 control-label">FAQ Type</label>
                                                            ...
                                                            <div class="col-md-9">
                                                                <select name="faq_type" class="form-control">
                                                                    <option value="User" <?php echo ($faq_master['type']=='User') ? 'selected' : '' ;?>>User</option>
                                                                    <option value="Vendor" <?php echo ($faq_master['type']=='Vendor') ? 'selected' : '' ;?>>Vendor</option>
                                                                </select>
                                                            </div>
                                                        </div>
							<div class="form-group"><label for="faq_status" class="col-md-3 control-label">FAQ Status</label>
                                                            ...
                                                            <div class="col-md-9">
                                                                <select name="faq_status" class="form-control">
                                                                    <option value="Active" <?php echo ($faq_master['faq_status']=='Active') ? 'selected' : '' ;?> >Active</option>
                                                                    <option value="Inactive" <?php echo ($faq_master['faq_status']=='Inactive') ? 'selected' : '' ;?> >Inactive</option>
                                                                </select>
                                                            </div>
                                                        </div>
