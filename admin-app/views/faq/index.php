            ...
            <div class="page-content">
                <div id="table-action" class="row">
                    <div class="col-lg-12">
						...
						if($faqList[$i]['faq_status'] == 'Active')
						{
							$status = 'Active';
						}
						else
						{
							$status = 'Inactive';
                                                ...
                                                <tr <?php echo $class; ?>>
                                                    ...
                                                    <td><?php echo stripslashes($faqList[$i]['faq_question']);?></td>
                                                    
                                                   <td>
			    <select name="faq_order" id="<?php echo $faqList[$i]['faq_id']; ?>" class="faq_order_change">
			      <?php    for($j=1 ; $j<=count($faqList) ; $j++){  ?>
			       <option value="<?php echo $j; ?>" <?php if($j==$faqList[$i]['faq_order']) {echo 'selected';} ?>><?php echo $j; ?>  </option>
			       <?php  }
			       ?>
			      </select>
			   </td>
						    ...
						    {
						    ?>
						    <label onclick="javascript:statusModifier('faq_status',this)" data-team='<?php echo $faqList[$i]['faq_id']; ?>' class="btn btn-success" title="Active"  >
						    ...
						    {
						    ?>
						    <label onclick="javascript:statusModifier('faq_status',this)" data-team='<?php echo $faqList[$i]['faq_id']; ?>' class="btn btn-primary" title="Inactive" >
...
<script>
  ...
  function searchValidation()
  {
    ...
    $( ".faq_order_change" ).change(function() {
    var faq_id=($(this).attr('id'));
    var faq_order=($(this).val());
    
    $.post(
	  '<?php echo site_url('faq/update_faq_order'); ?>', {faq_id:faq_id, faq_order:faq_order},
	   function(data){
