                                                        ...
                                                        <div class="form-group"><label for="inputEmail" class="col-md-3 control-label">Email <span class='require'>*</span></label>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="input-icon"><i class="fa fa-envelope"></i>
                                                                    <input type="text" readonly="readonly" id="email_address" name="email_address"  placeholder="Email Address" class="form-control required email_address" data-type="email" value="<?php echo stripslashes($user_info[0]['email_id']);?>"/>
                                                                </div>
                                                            </div>
                                                        </div>
