                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="panel panel-yellow portlet box portlet-violet">
                                            ...
                                            <div class="portlet-header">
                                                    <div class="caption">Add New Email Template</div>
                                                    <div class="tools">
						...
						<input type="hidden" name="action" value="Process">
                                                    <div class="form-body">
                                                        <div class="form-group"><label for="template_title" class="col-md-3 control-label">Template Title <span class='require'>*</span></label>
                                                            ...
                                                            <div class="col-md-4">
                                                                <input name="template_title" type="text" placeholder="Template Title" class="form-control required template_title" id="template_title" value="<?php echo set_value('template_title'); ?>"/>
                                                         ...
                                                         <div class="form-group"><label for="responce_email" class="col-md-3 control-label"> Email From<span class='require'> * </span></label>
                                                            ...
                                                            <div class="col-md-4">
                                                                <input name="responce_email" type="text" placeholder="Email From" class="form-control required email responce_email" id="responce_email" value="<?php echo set_value('responce_email'); ?>"/>
                                                        ...
                                                        <div class="form-group"><label for="email_subject" class="col-md-3 control-label">Email Subject<span class='require'> * </span></label>
                                                            ...
                                                            <div class="col-md-4">
                                                                <input name="email_subject" type="text" placeholder="Email Subject" class="form-control required email_subject" id="email_subject" value="<?php echo set_value('email_subject'); ?>"/>
                                                        ...
                                                        <div class="form-group"><label for="email_content" class="col-md-3 control-label">Email Content <span class='require'>*</span></label>
                                                            ...
                                                            <div class="col-md-9" id="editor">
                                                                    ...
                                                                    <textarea  name="email_content" id="editor1"  class="ckeditor form-control"><?php echo set_value('email_content');?></textarea>
